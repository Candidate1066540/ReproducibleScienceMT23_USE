# from the Github Practical Lesson (code written by France,L.,):
...
## NOTE: for the simplified nature of the work in the report in the Rmd, only the actions of the functions above are used.
## those below are featured (hased out) to aid the candidate 1066540 in learning. 
